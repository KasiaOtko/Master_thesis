...
parser.add_argument("--model", choices=["lr", "rf", "xgb"], help="Model to tune")
...
def LogReg(data, scale=True):
    ...
    for C in C_range:
        ...
        logging.info(
            "C = %d: Train_accuracy = %f, Validation accuracy = %f",
            C,
    ...
    lr = LogisticRegression(random_state=0, C=int(C_final), max_iter=300)
